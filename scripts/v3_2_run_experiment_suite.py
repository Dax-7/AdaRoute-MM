...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the AdaRoute-MM v3_2 risk-aware text-only experiment suite.")
    parser.add_argument("--suite", default="text_fusion_v3_2_basic")
    parser.add_argument("--dataset", default="data/datasets/v3_1_text_fusion/fusion_v3_1_1000_200-200-400-100-100.jsonl")
    parser.add_argument("--run-id", default=None)
    parser.add_argument("--experiments-dir", default="data/experiments_v3_2")
